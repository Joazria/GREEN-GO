class BandsController < ApplicationController
  ...
  def band_params
  params.require(:band).permit(:name, :release, :website, :facebook, :instagram, :youtube, :spotify, :soundcloud, :email, :city, :state, :country, :team, :yt_video_destak, :yt_video_two, :yt_video_one, :yt_video_three, :destak_discr, :headline, :photo)
  end
end
